...
//       {/* ✅ Event Card */}
//       <div className="relative bg-cyan-200 max-w-md w-full p-6 rounded-2xl shadow-2xl">
...
//             type="button"
//             onClick={() => navigate(-1)}
//             className="absolute top-4 left-4 bg-cyan-600 hover:bg-cyan-400
...
//           <p>📍 {event.location}</p>
//         </div>
//         <p className="text-center font-bold text-black mb-4">
//           {event.Description}
//         </p>
...
//         <button
//   onClick={() => navigate("/event-register",{state:{eventName:event.Title}})}
...
//       <button
//   onClick={() => navigate(`/event-participants/${event.Title}`)}
//   className="mt-6 w-full bg-cyan-700 hover:bg-cyan-800 
//              text-white py-2 rounded-lg font-semibold transition"
// >
//   View Participants

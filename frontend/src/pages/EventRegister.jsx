...
//     email: "",
//     mobile: "",
//     eventName: state?.eventName || "", // ✅ auto-filled
//     department: "",
//     year: ""
//   });
...
//     className="bg-white/95 backdrop-blur p-8 rounded-2xl shadow-2xl w-full max-w-md"
//   >
...
//       className="w-full mb-3 p-3 border rounded-lg focus:ring-2 focus:ring-cyan-500"
//       required
//     />
...
//       readOnly
//       className="w-full mb-3 p-3 border rounded-lg bg-gray-100 text-gray-700"
//     />
...
//       value={form.year}
//       onChange={handleChange}
//       className="w-full mb-5 p-3 border rounded-lg focus:ring-2 focus:ring-cyan-500"
//       required
//     />

//     <button className="w-full bg-cyan-700 hover:bg-cyan-800 text-white py-3 rounded-lg font-semibold transition">
//       Register Now
//     </button>
//   </form>
// </div>
